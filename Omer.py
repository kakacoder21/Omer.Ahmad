...
░╚════╝░╚═╝░░░░░╚═╝╚══════╝╚═╝░░╚═╝ 
 ---------------------------------------------------
 ➣ Author   : OMER - AHMAD
 ➣ GitHub   : https://github.com/NoOne07
 ➣ YouTube  : OMAR
 ➣ telegram : https://t.me/kurdgamers_0
 ---------------------------------------------------
       Created By ZED 
 ---------------------------------------------------
...
░╚════╝░╚═╝░░░░░╚═╝╚══════╝╚═╝░░╚═╝
 ...
 --------------------------------------------------'''
    ...
    if ia=="1":
        os.system("xdg-open https://t.me/kurdgamers_0")
        instagram1()
    elif ia=="2":
        import wget, os
...
def hala():
    ...
    if 'pain.txt' in x:
        ...
        textupload = requests.get('https://textuploader.com/tarhr').text
